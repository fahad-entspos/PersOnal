...
//   return (
//     <Box sx={{backgroundColor:"black"}} component="footer" square variant="outlined">
...
//           }}
//         >
//           <List sx={{display:"flex",fontSize:"38px",color:"white"}}>
...
//           }}
//         >
//           <Typography sx={{fontSize:"15px",fontFamily:" sans-serif"}} variant="caption" color="initial"  style={{ textDecoration: "none", color: "white" }}>
//             Copyright ©2023. [] FaHaD Mughal
//           </Typography>
//         </Box>
//       </Container>
//     </Box>
